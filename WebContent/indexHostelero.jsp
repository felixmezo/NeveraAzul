	...
	<c:if test="${not empty user}">
		<c:if test="${not empty productosPublicados}">
			<div class="panel panel-default">
				<div class="panel-heading">Productos publicados en La Nevera Azul</div>
				<div class="panel-body">
					<p><strong><c:out value="${user}"></c:out></strong> </p>
					<p>Establecimiento: <c:out value="${nombreEstablecimiento}"></c:out> </p>
					<p>Tienes publicados un total de <c:out value="${fn:length(productosPublicados)}"/> productos(s).</p>
				</div>
				<table class="table">
					<tr>
						<th>Nombre</th>
			...
			<c:if test="${empty productosPublicados}">
				<p>Hola <strong><c:out value="${user}"></c:out></strong> </p>
				<p>Establecimiento: <c:out value="${nombreEstablecimiento}"></c:out> </p>
...
<!-- 	<p>Pulsa el boton para <a href="/">Volver</a></p> -->
<!-- 	<p>Pulsa el boton para <a href="/registroProducto">Publicar Nuevo Producto</a></p> -->
